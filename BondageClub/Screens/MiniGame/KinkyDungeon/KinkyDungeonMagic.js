...
var KinkyDungeonSpells = {
	"Elements": [{name: "Firebolt", components: "Arms", level:1, type:"bolt", power: 3, delay: 0, range: 50, damage: "fire"}], // Throws a fireball in a direction that moves 1 square each turn
	"Conjure": [{name: "Snare", components: "Legs", level:1, type:"trap", power: 10, delay: 1, range: 3, damage: "stun", playerEvent: {name: "MagicRope", time: 10}}], // Creates a magic rope trap that creates magic ropes for 10 seconds on anything that steps on it. They are invisible once placed. Enemies get rooted, players get fully tied!
	"Illusion": [{name: "Flash", components: "Verbal", level:1, type:"aoe", power: 10, range: 4, power: 3, size: 1, damage: "blind"}], // Start with flash, an explosion with a 1 turn delay and a 3 tile radius. If you are caught in the radius, you also get blinded temporarily!
} 
