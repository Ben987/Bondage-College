...
var KinkyDungeonSpellList = { // List of spells you can unlock in the 3 books. When you plan to use a mystic seal, you get 3 spells to choose from.
	...
	"Illusion": [
		...
		{ name: "Clairvoyance", exhaustion: 3, components: ["Verbal"], level:4, type:"inert", projectile:false, onhit:"allsee", time:1, aoe: 1.5, power: 0, delay: 1, range: 0, size: 3, damage: ""}, // Creates a shroud. Enemies within are hard to hit with melee attacks.
	],
};
