...
function KinkyDungeonCheckLOS(enemy, distance, maxdistance) {
	return distance <= maxdistance && KinkyDungeonCheckPath(enemy.x, enemy.y, KinkyDungeonPlayerEntity.x, KinkyDungeonPlayerEntity.y)
}
