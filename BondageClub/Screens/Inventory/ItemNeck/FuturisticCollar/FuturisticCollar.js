...
function InventoryItemNeckFuturisticCollarDraw() {
	...
	if (InventoryItemMouthFuturisticPanelGagValidate(C) !== "") {
		...
		DrawButton(1125, 465, 64, 64, "", "White", DialogFocusItem.Property.OpenPermission ? "Icons/Checked.png" : "");
		DrawText(DialogFind(Player, "FuturisticCollarOpenPermission"), 1550, 490, "White", "Gray");
...
function InventoryItemNeckFuturisticCollarClick() {
	...
	if (InventoryItemMouthFuturisticPanelGagValidate(C) !== "") {
		...
		else if (MouseIn(1125, 465, 64, 64)) InventoryItemNeckFuturisticCollarTogglePermission(C, DialogFocusItem);
		else {
