...
function InventoryItemMiscMistressTimerPadlockDraw() {
    ...
    if (DialogFocusSourceItem.Property.ShowTimer || (!DialogFocusSourceItem.Property.ShowTimer && ((Player.MemberNumber == DialogFocusSourceItem.Property.LockMemberNumber) || LogQuery("ClubMistress", "Management")))) {
    ...
    //todo add way to replace the number of minutes by removetimer property (in minutes)
    if (Player.CanInteract() && LogQuery("ClubMistress", "Management")) DrawButton(1350, 700, 300, 65, DialogFind(Player, "Add15minTimer"), "White");
