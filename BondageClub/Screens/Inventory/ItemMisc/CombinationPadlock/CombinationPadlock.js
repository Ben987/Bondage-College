...
function InventoryItemMiscCombinationPadlockLoad() {
	...
	if (DialogFocusSourceItem != null && ((Player.MemberNumber == DialogFocusSourceItem.Property.LockMemberNumber)
		|| (C.Ownership != null && (Player.MemberNumber == C.Ownership.MemberNumber))
		|| (C.Lovership != null && (Player.MemberNumber == C.Lovership.MemberNumber)))) document.getElementById("CombinationNumber").placeholder = DialogFocusSourceItem.Property.CombinationNumber;
}
