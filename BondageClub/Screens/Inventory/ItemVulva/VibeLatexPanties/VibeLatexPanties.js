...
function InventoryItemVulvaVibeLatexPantiesLoad() {
...
function InventoryItemVulvaVibeLatexPantiesDraw() {
...
function InventoryItemVulvaVibeLatexPantiesClick() {
	if ((MouseX >= 1885) && (MouseX <= 1975) && (MouseY >= 25) && (MouseY <= 110)) DialogFocusItem = null;
	if ((MouseX >= 1200) && (MouseX <= 1450) && (MouseY >= 700) && (MouseY <= 765) && (DialogFocusItem.Property.Intensity > -1)) InventoryItemVulvaVibeLatexPantiesSetIntensity(-1);
	if ((MouseX >= 1550) && (MouseX <= 1800) && (MouseY >= 700) && (MouseY <= 765) && (DialogFocusItem.Property.Intensity < 3)) InventoryItemVulvaVibeLatexPantiesSetIntensity(1);
}

// Sets the vibe latex panties intensity
function InventoryItemVulvaVibeLatexPantiesSetIntensity(Modifier) {
	...
	ChatRoomPublishCustomAction((DialogFind(Player, "Egged" + ((Modifier > 0) ? "Increase" : "Decrease") + "To" + DialogFocusItem.Property.Intensity)).replace("DestinationCharacter",C.Name), true);
}
