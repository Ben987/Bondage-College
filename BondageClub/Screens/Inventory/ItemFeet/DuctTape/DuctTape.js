...
function InventoryItemFeetDuctTapeClick() {
	...
	if ((MouseX >= 1250) && (MouseX <= 1475) && (MouseY >= 550) && (MouseY <= 775) && (DialogFocusItem.Property.Type != "HalfFeet")) InventoryItemFeetDuctTapeSetPose("HalfFeet");
	if ((MouseX >= 1500) && (MouseX <= 1725) && (MouseY >= 550) && (MouseY <= 775) && (DialogFocusItem.Property.Type != "MostFeet")) InventoryItemFeetDuctTapeSetPose("MostFeet");
	if ((MouseX >= 1750) && (MouseX <= 1975) && (MouseY >= 550) && (MouseY <= 775) && (DialogFocusItem.Property.Type != "CompleteFeet")) InventoryItemFeetDuctTapeSetPose("CompleteFeet");
}
