...
function ManagementAllowReleaseChastity() { return (Player.IsChaste() && (ManagementCanReleaseChastity && !InventoryOwnerOnlyItem(InventoryGet(Player, "ItemBreast")) &&  (!InventoryOwnerOnlyItem(InventoryGet(Player, "ItemVulvaPiercings")) || InventoryGroupIsBlocked(Player, "ItemVulvaPiercings")) && (!InventoryOwnerOnlyItem(InventoryGet(Player, "ItemNipplesPiercings")) || InventoryGroupIsBlocked(Player, "ItemVulvaPiercings")) && (!InventoryOwnerOnlyItem(InventoryGet(Player, "ItemButt")) || InventoryGroupIsBlocked(Player, "ItemVulvaPiercings")) && !InventoryOwnerOnlyItem(InventoryGet(Player, "ItemPelvis")))) }
