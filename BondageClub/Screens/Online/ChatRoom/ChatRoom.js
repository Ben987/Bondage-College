...
function ChatRoomRun() {
	...
	DrawButton(1254, 2, 120, 60, "", (Player.CanKneel()) ? "White" : ((ChatRoomGetUpTimer == 0 && (ChatRoomCanAttemptStand() || ChatRoomCanAttemptKneel())) ? "#FFFF00" : "Pink"), "Icons/Rectangle/Kneel.png", TextGet("MenuKneel"));
