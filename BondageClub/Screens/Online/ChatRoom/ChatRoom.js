...
function ChatRoomSendChat() {
	...
	if (msg != "") {
		...
		} else if ((m.indexOf("*") == 0) || (m.indexOf("/me ") == 0) || (m.indexOf("/action ") == 0) || (Player.ChatSettings.MuStylePoses && m.indexOf(":") == 0 && (m.indexOf("'s") == 1 || !ChatMuPoseIgnoreCharacters.includes(m[1].toLowerCase())))) {
