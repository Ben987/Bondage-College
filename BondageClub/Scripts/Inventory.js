...
function InventoryLock(C, Item, Lock, MemberNumber) {
	...
	if (Item && Lock && Item.Asset.AllowLock) {
		...
		if ((C.ID == 0) && Lock.Asset.OwnerOnly && (C.Ownership != null) && (C.Ownership.MemberNumber != null) && !LogQuery("BlockOwnerLockSelf", "OwnerRule")) Item.Property.LockMemberNumber = Player.MemberNumber;
