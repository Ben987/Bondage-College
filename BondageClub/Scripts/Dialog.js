...
function DialogLockPickProgressStart(C, Item) {
	...
	if (Item != null && lock) {
		...
		var NumTries = Math.floor(Math.max(NumPins * (1.5 - 0.3*BondageLevel/10),
				NumPins * (3.25 - BondageLevel/10) - Math.max(0, (DialogLockPickProgressChallenge + BondageLevel/2)*NumPins/4)))
