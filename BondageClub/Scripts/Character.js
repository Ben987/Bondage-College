...
function CharacterReset(CharacterID, CharacterAssetFamily) {
	...
	var NewCharacter = {
		...
		CanKneelAssisted: function () { return ((CharacterItemsHavePose(this, "LegsClosed")) && (this.Effect.indexOf("ForceKneel") < 0) && (this.Effect.indexOf("Mounted") < 0) && ((this.Pose == null) || (((this.Pose.indexOf("Supension") < 0) && (this.Pose.indexOf("Hogtied") < 0))))) },
		CanStandAssisted: function () { return ((CharacterItemsHavePose(this, "LegsClosed")) && (this.Effect.indexOf("ForceKneel") < 0) && (this.Effect.indexOf("Mounted") < 0) && ((this.Pose == null) || (((this.Pose.indexOf("Supension") < 0) && (this.Pose.indexOf("Hogtied") < 0))))) },
