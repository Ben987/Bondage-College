...
function CharacterReset(CharacterID, CharacterAssetFamily) {
	...
	var NewCharacter = {
		...
		IsSlow: function () { return (this.Effect.indexOf("Slow") >= 0 || (Player.ImmersionSettings && Player.ImmersionSettings.SlowWhenLegsBound && (this.Pose.indexOf("LegsClosed") >= 0 || this.Pose.indexOf("Kneel") >= 0))) },
