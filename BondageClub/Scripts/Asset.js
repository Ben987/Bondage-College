...
function AssetGroupAdd(NewAssetFamily, NewAsset) {
	var A = {
		...
		Bodypart: (NewAsset.Bodypart == null) ? false : NewAsset.Bodypart,
...
function AssetAdd(NewAsset) {
	var A = {
		...
		Clothing: (NewAsset.Clothing == null) ? ((AssetCurrentGroup.Clothing == null) ? false : AssetCurrentGroup.Clothing) : NewAsset.Clothing,
		Bodypart: (NewAsset.Bodypart == null) ? ((AssetCurrentGroup.Bodypart == null ) ? false : AssetCurrentGroup.Bodypart) : NewAsset.Bodypart,
