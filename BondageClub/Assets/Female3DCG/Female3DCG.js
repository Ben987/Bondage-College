...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "FuturisticCrate", Priority: 58, Category: "SciFi", Fetish: ["Metal"], Value: 70, Difficulty: -2, SelfBondage: 1, Time: 15, RemoveTime: 10, AllowLock: true, Audio: "LockLarge", Prerequisite: ["NotSuspended"], LayerVisibility: true, Effect: ["Prone", "Enclose", "GagLight", "Freeze"],  HideItem: ["ShoesFlippers"],
