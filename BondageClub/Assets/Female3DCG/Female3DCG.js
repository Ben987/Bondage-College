...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "WoodenStocks", RemoveAtLogin: true, Value: 150, Time: 10, Difficulty: 50, AllowLock: true, SetPose: ["Yoked"], Effect: ["Prone", "Freeze", "Block", "Mounted"], Prerequisite: ["AllFours", "NotSuspended", "NotHogtied", "NotKneelingSpread", "NoItemArms"], Block: ["ItemArms", "ItemFeet", "ItemLegs", "ItemBoots"]}
		]
	},
