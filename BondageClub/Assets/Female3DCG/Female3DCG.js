...
var AssetFemale3DCG = [
...

	{
		...
		Top: 400,
		Asset: [
			{ Name: "Socks0", AlphaRange: { Min: 0.4, Max: 1 } },
			...
			{ Name: "Pantyhose1", AlphaRange: { Min: 0.4, Max: 1 }, Value: 10, Priority: 16, Block: ["ItemVulva", "ItemButt"], HideItem: ["ItemVulvaVibratingDildo"] }
			{
