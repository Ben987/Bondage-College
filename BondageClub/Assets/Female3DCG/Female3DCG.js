...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "Stockade", RemoveAtLogin: true, Value: 150, Time: 10, Difficulty: 50, AllowLock: true, SetPose: ["Yoked"], Effect: ["Prone", "Freeze", "Block", "mounted"], Prerequisite: ["AllFours", "NotSuspended", "NotHogtied", "NotKneelingSpread"], Block: ["ItemArms", "ItemFeet", "ItemLegs", "ItemBoots"]}
		]
	},
