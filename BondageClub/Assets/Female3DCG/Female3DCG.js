...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "ScifiChastityBelt", Fetish: ["Metal"], Priority: 23, Value: 170, Difficulty: 50, Time: 10, RemoveTime: 5, AllowLock: true, BuyGroup: "TechBelts", DefaultColor: ["#3b1866", "#5a00cc", "Default"], Audio: "CuffsMetal", Prerequisite: "AccessVulva", HideItem: ["ItemButtAnalBeads2", "ItemVulvaVibratingDildo", "ItemVulvaClitSuctionCup", "ItemVulvaInflatableVibeDildo", "ItemVulvaHeavyWeightClamp", "ItemVulvaPenisDildo", "ItemVulvaShockDildo", "ItemVulvaPiercingsVibeHeartClitPiercing"], Effect: ["Chaste", "Egged"], AllowBlock: ["ItemButt"], ArousalZone: "ItemVulva", AllowEffect: ["Egged", "Vibrating", "OrgasmLock"], AllowType: ["ClosedBack"], Block: ["ItemVulva", "ItemVulvaPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }], Extended: true, HasType: false,
				Layer: [
					{ Name: "Mesh", AllowColorize: true },
					{ Name: "Screen", AllowColorize: true },
					{ Name: "Belt", AllowColorize: true },
			...
			{ Name: "CrotchChain", Fetish: ["Metal"], Value: 40, Difficulty: 50, Time: 15, RemoveTime: 10, AllowLock: true, Audio: "ChainLong", Prerequisite: "AccessTorso" },
{
...

	{
		...
		Asset: [
			...
			{ Name: "FuturisticBra", Fetish: ["Metal"], Value: 120, Difficulty: 50, Time: 10, AllowLock: true, BuyGroup: "TechBras", DefaultColor: ["#50913C", "#889FA7", "Default"], Audio: "CuffsMetal", Prerequisite: "AccessBreast", Hide: ["ItemNipples", "ItemNipplesPiercings"], Effect: ["BreastChaste"], Block: ["ItemNipples", "ItemNipplesPiercings"], ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }],
				Layer: [
					{ Name: "Display" },
					{ Name: "Mesh" },
					{ Name: "Bra" },
			...
			{ Name: "ScifiBra", Fetish: ["Metal"], Value: 120, Difficulty: 50, Time: 10, AllowLock: true, BuyGroup: "TechBras", DefaultColor: ["#5a00cc", "#3b1866", "Default"], Audio: "CuffsMetal", Prerequisite: "AccessBreast", Hide: ["ItemNipples", "ItemNipplesPiercings"], Effect: ["BreastChaste", "Egged"], ArousalZone: "ItemNipples", AllowEffect: ["Egged", "Vibrating", "OrgasmLock"], Block: ["ItemNipples", "ItemNipplesPiercings"], Extended: true, ExpressionTrigger: [{ Name: "Soft", Group: "Eyebrows", Timer: 10 }],
				Layer: [
					{ Name: "Display" },
					{ Name: "Mesh" },
					{ Name: "Bra" },
