...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "CaptureBall", RemoveAtLogin: true, IsRestraint: false, Value: 50, Time: 10, Block: ["ItemArms", "ItemBreast", "ItemButt", "ItemEars", "ItemFeet", "ItemHands", "ItemHead", "ItemLegs", "ItemMisc", "ItemMouth", "ItemNeck", "ItemNeckAccessories", "ItemNipples", "ItemPelvis", "ItemTorso", "ItemVulva"], SetPose: ["Kneel"], Hide: ["HairFront", "HairBack", "Glasses", "ItemMouth", "Eyes", "Hat", "HairAccessory", "Blush", "BodyLower", "BodyUpper", "Bra", "Cloth", "ClothLower", "Eyebrows", "Gloves", "HairAccessory", "Hands", "ItemArms", "ItemBoots", "ItemBreast", "ItemButt", "ItemEars", "ItemFeet", "ItemHands", "ItemHead", "ItemLegs", "ItemMisc", "ItemNeck", "ItemNeckAccessories", "ItemNipples", "ItemPelvis", "ItemTorso", "ItemVulva", "Mouth", "Nipples", "Panties", "Pussy", "Shoes", "Socks", "TailStraps", "Wings"] }
		]
	},
