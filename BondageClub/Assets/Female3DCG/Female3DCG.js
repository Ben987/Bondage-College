...
var AssetFemale3DCG = [
	...
	// Appearance specific
	{
		...
		Asset: [
			...
			{
				Name: "CorsetShirt", Fetish: ["Lingerie"], Priority: 29, Value: 60, HideItem: ["ItemNipplesPiercingsRoundPiercing", "ItemNipplesPiercingsWeightedPiercing", "ItemNipplesLactationPump"],
				Layer: [
					{ Name: "Shirt" },
					{ Name: "Corset" }
				]
			...
			{ Name: "CrotchChain", Fetish: ["Metal"], Value: 40, Difficulty: 50, Time: 15, RemoveTime: 10, AllowLock: true, Audio: "ChainLong", Prerequisite: "AccessTorso" },
{
...

	{
		...
		Asset: [
			...
			{ Name: "MetalCuffs", Fetish: ["Metal"], Priority: 28, Value: 40, Difficulty: 5, Time: 5, Audio: "LockSmall", SetPose: ["BackCuffs"], Effect: ["Block", "Prone", "Lock"] },
			...
			{ Name: "LeatherCuffs", Fetish: ["Leather"], Priority: 28, Value: 100, Left: 0, Top: 0, Difficulty: 3, Time: 20, Random: false, AllowLock: true, DefaultColor: "#404040", AllowPose: ["BackBoxTie", "BackElbowTouch", "OverTheHead", "BackCuffs", "Yoked"], Effect: ["CuffedArms"], AllowEffect: ["Block", "Prone"], AllowType: ["Wrist", "Elbow", "Both"], Extended: true, HasType: false },
			{
				Name: "OrnateCuffs", Fetish: ["Metal"], Priority: 28, Value: 200, Left: 0, Top: 0, Difficulty: 4, Time: 20, Random: false, AllowLock: true, Audio: "CuffsMetal", AllowPose: ["BackBoxTie", "BackElbowTouch", "OverTheHead", "BackCuffs", "Yoked"], Effect: ["CuffedArms"], AllowEffect: ["Block", "Prone"], AllowType: ["Wrist", "Elbow", "Both"], Extended: true, HasType: false,
				Layer: [
					{ Name: "Cuffs" },
					{ Name: "Gems" },
				],
