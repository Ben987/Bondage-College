...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{
				Name: "HarnessDildoGag", Effect: ["GagHeavy"], Difficulty: 4, Value: 60, Time: 20, AllowLock: true,
				Layer: [
					{ Name: "Harness", AllowColorize: false },
...

	{
		...
		Asset: [
			...
			{ Name: "LeatherHoodOpenMouth", Effect: ["Prone", "BlindHeavy"], Hide: ["HairFront", "HairBack", "Glasses"], Difficulty: 50, Value: 60, Time: 15, AllowLock: true }
		]
	},
