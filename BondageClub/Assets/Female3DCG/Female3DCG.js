...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "Manacles", Value: 250, AllowLock: true, SelfBondage: false, Difficulty: 16, SetPose: ["BackBoxTie", "Kneel"], Effect: ["Block", "Prone", "ForceKneel"], Time: 30, Prerequisite: ["FeetNotBound", "NotSuspendedOrHorsed"], Block: ["ItemFeet"] },
			{ Name: "FullBodyShackles", Value: 500, AllowLock: true, Difficulty: 18, AllowPose: ["LegsClosed", "Kneel"], Effect: ["Prone", "Shackled"], Prerequisite: ["FeetNotBound", "NotSuspendedOrHorsed"], Block: ["ItemFeet"]},
