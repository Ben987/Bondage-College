...
var AssetFemale3DCG = [
	...
	// Item specific
	{
		...
		Asset: [
			...
			{ Name: "SpreaderMetal", Value: 50, Time: 10, Difficulty: 3, AllowLock: true, Effect: [ "Freeze", "Prone"], SetPose: ["LegsOpen"], Block: ["ItemLegs"],  Prerequisite: "LegsOpen", RemoveAtLogin: true },
