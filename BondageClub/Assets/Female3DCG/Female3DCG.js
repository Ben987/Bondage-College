...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "NeckRope", Value: 10, Difficulty: 50, Time: 5, AllowLock: false, DefaultColor: "#956B1C", ExpressionTrigger: [{ Name: "Medium", Group: "Blush", Timer: 3 }, { Name: "Soft", Group: "Eyebrows", Timer: 3 }] },
			AssetSpankingToys
		],
		Color: ["Default"]
	},
