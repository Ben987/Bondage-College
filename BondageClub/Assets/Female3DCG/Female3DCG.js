...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "LockingVibe", Effect: ["IsPlugged", "Egged"], Value: 90, Difficulty: 40, Time: 10, RemoveTime: 40, IsRestraint: true, AllowLock: true, Prerequisite: ["AccessVulva", "AccessVulvaSuitZip"], ExpressionTrigger: [{ Group: "Blush", Name: "High", Timer: 10 }], AllowEffect: ["Egged", "Vibrating", "Edged"], Visible: false},
