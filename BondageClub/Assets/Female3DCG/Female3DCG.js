...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "Stockade", RemoveAtLogin: true, Value: 150, Time: 10, Difficulty: 50, AllowLock: true, SetPose: ["Yoked", "LegsOpen"], Effect: ["Prone", "Freeze", "Block"], Prerequisite: ["NotSuspended", "NotHogtied", "NotMounted", "NotKneelingSpread", "NoFeetSpreader", "NotYoked"], Block: ["ItemArms", "ItemFeet", "ItemLegs", "ItemBoots"]}
		]
	},
