...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "OneBarPrison", Value: 100, Time: 20, Difficulty: 15, AllowLock: false, SetPose: ["LegsOpen"], Prerequisite: "OBP", RemoveAtLogin: true, Block: ["ItemPelvis", "ItemLegs", "ItemVulva", "ItemFeet"], Effect: ["Prone", "Freeze"],
				Layer: [
