...
var AssetFemale3DCG = [
...

	{
		...
		Asset: [
			...
			{ Name: "DoubleEndDildo", Value: 15, Time: 10, Effect: ["FillVulva"], Prerequisite: ["AccessVulva", "AccessVulvaSuitZip"], AllowActivity: ["Penetrate"], ExpressionTrigger: [{ Name: "Medium", Group: "Blush", Timer: 20 }], AllowActivity: ["Penetrate"] },
			AssetSpankingToys
		],
		Color: ["Default"]
	},
