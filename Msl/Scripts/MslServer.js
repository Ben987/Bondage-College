...
var MslServer = {
	...
	,Init(){
		...
		MslServer.socket.on("FriendMessage", resp => MslServer.ServerResponse(resp, MainController.OnFriendMessage));
		MslServer.socket.on("LocationAction", resp => MslServer.ServerResponse(resp, LocationController.OnLocationAction));
	}
